...
public class TutorialPartI extends EOpenglESActivity implements IEOpenGLDemo {
    ...
    public void zoom(float newDist, float oldDist) {
        ...
        ball.zoom += (newDist - oldDist) * (ball.maxZoom - ball.minZoom) / (float) Math.sqrt(px * px + py * py) / 4;
